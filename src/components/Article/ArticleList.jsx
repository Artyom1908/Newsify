...
function ArticleList({ articles, handleArticleClick }) {
    ...
    const AddArticle = (article) => {
        ...
        setClickedArticles([...clickedArticles, article.title]);
    }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {
                articles.map((article, i) => (
                    <div key={i} className="max-w-sm rounded overflow-hidden shadow-lg mx-4 my-4">
                        ...
                        <div className="px-6 py-4 align-i">
                            ...
                            <span
                                ...
                                className={
                                    "inline-block bg-gray-200 rounded-full px-3 py-1 text-gray-700 text-sm font-semibold mr-2 mb-2 focus:outline-none active:box-shadow-outline-blue" +
                                    (clickedArticles.includes(article.title) ? " text-gray-900" : '')
                                }
                            >
